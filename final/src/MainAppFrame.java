...
//import statements for the awt and swing that are going to be used
...
public class MainAppFrame extends JFrame {
	...
	private final JPasswordField txtFieldPassword = new JPasswordField(); //create the text field to enter the password
	...
	public static int SignedInAccount;
	/**
	...
	public MainAppFrame() {
		...
		CreateTables tbls = new CreateTables();
		tbls.createStudentAndEmployeeTables();
		...
		btnLogin.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				//Account_Employee Actual_Employee_Account = null;
					...
					if(ac_stud1.SignIn(txtFieldLogin.getText(), txtFieldPassword.getText())) {
						//if login and password match and exist in the list
						//keep record of the actual account of the logged in student
						//Actual_Student_account = ac_stud1.Current_Student(txtFieldLogin.getText(), txtFieldPassword.getText(), ac_students);
						Account_info acinf = new Account_info();
						ac_info.setInfo(txtFieldLogin.getText(), txtFieldPassword.getText(), SignedInAccount);////display the details of the logged in student
						dispose();//close the login window
						ac_info.setVisible(true);
