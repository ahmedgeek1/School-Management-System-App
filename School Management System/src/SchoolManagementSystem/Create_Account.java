...
public class Create_Account extends JFrame {
	...
	/**
	 * building the create_account window
	 */
	...
	private final JTextField textFieldCreatePassword = new JTextField();//texfield for user to enter password for the new account to be created 
		...
		btnCreateAccount.addActionListener(new ActionListener() { //if create account has been pressed
			public void actionPerformed(ActionEvent e) {
				...
				JOptionPane.showMessageDialog(null, "Please enter all the required fields");
					...
					userNameExists = Account.verify_user_exists(Textfieldcreateuserid.getText(), MainAppFrame.ac_students, MainAppFrame.ac_employees); //verify if the username entered exists in the listy
					if(!userNameExists) { //if it doesn't exists
					//create a new student account
					Account_student ac_stud = new Account_student(Textfieldcreateuserid.getText(), textFieldCreatePassword.getText(), textFieldCreateName.getText(), textFieldCreateEmail.getText(), textFieldCreatePhoneNumber.getText(), textFieldCreateSex.getText(), 0, textFieldCreateVar1.getText(), textFieldCreateVar2.getText());
					...
					boolean userNameExists;
					userNameExists = Account.verify_user_exists(Textfieldcreateuserid.getText(), MainAppFrame.ac_students, MainAppFrame.ac_employees);
					if(!userNameExists) {//if it doesn't exists
						//create a new employee account
					Account_Employee ac_emp = new Account_Employee(Textfieldcreateuserid.getText(), textFieldCreatePassword.getText(), textFieldCreateName.getText(), textFieldCreateEmail.getText(), textFieldCreatePhoneNumber.getText(), textFieldCreateSex.getText(), textFieldCreateVar1.getText(), textFieldCreateVar2.getText());
